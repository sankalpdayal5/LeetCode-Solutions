...
|------|------------------------------|-------------|-----------------|------|-------|------------|--------------|----------|
| 0021 | [Merge sorted LinkedList](https://leetcode.com/problems/merge-two-sorted-lists/) | Traverse the linkedlist and compare elements. Append the lesser one to answer and atlast check the left over elements of linkedlist| [C++](https://github.com/sankalpdayal5/LeetCode-Solutions/blob/master/C++/0021.cpp)     | O(N + M) | O(N + M)  | Easy    | Merging Sorted Traversal|    |

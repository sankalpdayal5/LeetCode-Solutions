...
| 0136 | [Find the number occuring only once when all others occur twice](https://leetcode.com/problems/single-number/) | Make use of the XOR properties | [C++](https://github.com/sankalpdayal5/LeetCode-Solutions/blob/master/C++/0136.java)     | O(n) | O(1)  | easy     | XOR Bitwise         |          |
